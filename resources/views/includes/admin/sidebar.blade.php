    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview"> <a href= "#"> <i class="fa fa-fw fa-users"></i> <span>Usuarios</span>  <i class="fa fa-angle-left pull-right"></i>  </a> 
              <ul class="treeview-menu">
                    <li><a href="{{ action('ProductsController@index') }}"><i class="fa fa-circle-o"></i> Mostrar Usuarios</a></li>
                    <li><a href="{{ action('ProductsController@create') }}"><i class="fa fa-circle-o"></i> Crear Usuarios</a></li>
              </ul>
            </li>
        </ul>    
    </section>
